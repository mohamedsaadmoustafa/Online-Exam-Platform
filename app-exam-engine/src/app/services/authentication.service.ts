...
export class AuthenticationService {
  ...
  public register(userRegistration: UserRegistrationModel) {
    this.authenticationClient.register(userRegistration)
      .pipe(
        tap((token) => {
          if (token) {
            this.alertService.show('Registration successful', 'alert-success');
            this.storageService.saveUser(token);
